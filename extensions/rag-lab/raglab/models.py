...
class SearchStore(Protocol):
    ...
    def read_window(self, anchor_id: str, *, corpus_ids: Sequence[str], release: str | None = None, before: int = 3, after: int = 3, limit: int = 16, max_chars: int = 24000) -> list[Evidence]: ...
...
class Generator(Protocol):
    def generate(self, question: Question, evidence: Sequence[Evidence], *, retrieval_feedback: dict | None = None) -> Answer: ...
